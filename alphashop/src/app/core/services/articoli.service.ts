...
export class ArticoliService {
  ...
  articoli: IArticoli[]  = [
    ...
    {codart : "014649001", descrizione : "BARILLA PANNE RIGATE 500 GR", um : "PZ", pzcart : 12, peso : 0.5, prezzo : 0.89, active : false, data : new Date(), imageUrl: 'assets/images/prodotti/014649001.jpg'},
